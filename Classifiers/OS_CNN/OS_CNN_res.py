...
class OS_CNN_res(nn.Module):
    def __init__(self,layer_parameter_list,n_class, n_layers, few_shot = True):
        ...
        #每一个Res_OS_layer都生成一个OS-Block
        self.net_1 = Res_OS_layer(layer_parameter_list,out_put_channel_numebr) #out_put_channel_numebr作为self.net的in_put_channel_number
        ...
        self.net = nn.Sequential(*self.net_list) #把所有OS-Block顺序相连，形成网络
